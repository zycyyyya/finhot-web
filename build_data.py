...
TIER_MAP = {
    ...
    # WeChat accounts (T2)
    "吴晓波频道": 0.70, "13个精算师": 0.70, "保险一哥": 0.70, "今日保": 0.70,
    "Hanson老登": 0.70, "政信三公子": 0.70, "风云君的研究笔记": 0.70,
    "思想钢印": 0.70, "猫笔刀": 0.70,
}

# ── WeChat account queries ──────────────────────────────────────────
# neodata keywords mapped to each WeChat public account.
# Each query is run during data collection, results sourced to account name.
# 国家金融监督管理总局 is already covered as T1 source (gov queries).
WECHAT_QUERIES = [
    ("吴晓波频道",     "财经评论 宏观经济 产业观察 企业案例"),
    ("13个精算师",     "保险精算 产品定价 偿付能力 险企财务"),
    ("保险一哥",       "保险行业动态 险企经营 保险科技 数字化转型"),
    ("今日保",         "保险新闻 监管处罚 保险产品创新 保费数据"),
    ("Hanson老登",     "保险销售技巧 代理人观点 保险合规 客户沟通"),
    ("政信三公子",     "城投债 地方债务 信用债 政信类产品 化债"),
    ("风云君的研究笔记","行业深度研究 公司基本面分析 财报解读 估值"),
    ("思想钢印",       "投资理念 市场复盘 价值投资 行为金融学"),
    ("猫笔刀",         "A股复盘 投资随笔 市场情绪 个股分析"),
]
